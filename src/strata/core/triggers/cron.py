"""5-Field Cron Expression Evaluator & Trigger Subsystem Module for Strata Engine.
...
from strata.core.dag.ast import TriggerSpec
from strata.core.dag.exceptions import StrataError
from strata.core.triggers.base import BaseTrigger
from strata.utils.logger import get_logger

logger = get_logger(__name__)


class CronParseError(StrataError):
