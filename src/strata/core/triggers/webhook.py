"""HTTP Webhook Ingestion & Signature Verification Subsystem Module for Strata Engine.
...
from strata.core.dag.ast import TriggerSpec, TriggerType
...
class WebhookAuthenticationError(StrataError):
...
class WebhookTrigger(BaseTrigger):
    ...
    def process_webhook(
        ...
        signature_header_name: str = "X-Strata-Signature",
    ) -> TriggerEvent:
