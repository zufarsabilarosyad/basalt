"""Abstract Base Task Executor Subsystem Module for Strata Workflow Engine.
...
class ExecutorError(StrataError):
...
class BaseExecutor(abc.ABC):
    """Abstract Base Class for all Strata task executor plugins."""
