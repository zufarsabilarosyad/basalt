"""Asynchronous HTTP API Step Executor Subsystem Module for Strata Engine.
...
from strata.core.dag.ast import StepSpec
...
from strata.utils.validators import validate_url
...
class HTTPExecutor(BaseExecutor):
    ...
    def build_headers(
        ...
        headers: dict[str, str] = {"User-Agent": "Strata-Workflow-Engine/1.0"}
        if raw_headers:
