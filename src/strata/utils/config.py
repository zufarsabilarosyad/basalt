"""Central Configuration Management Module for Strata Workflow Engine.
...
class APISettings(BaseModel):
    ...
    title: str = Field(
        default="Strata Workflow Engine API",
