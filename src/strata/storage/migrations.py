"""Lightweight Database Schema Migration Subsystem Module for Strata Engine.
...
from strata.storage.database import Base, DatabaseManager
...
MIGRATION_REGISTRY: list[Migration] = [
    Migration(
        version=1,
        description="Initial Strata database tables schema",
        up_sql=[
