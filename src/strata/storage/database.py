"""Async SQLite Database Engine & Session Subsystem Module for Strata Engine.
...
class DatabaseManager:
    ...
    def __init__(self, database_url: str = "sqlite+aiosqlite:///strata.db") -> None:
...
@lru_cache(maxsize=1)
def get_db_manager(db_url: str = "sqlite+aiosqlite:///strata.db") -> DatabaseManager:
